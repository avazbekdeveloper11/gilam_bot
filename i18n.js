...
Xizmatimizdan foydalanganingiz uchun rahmat! 🙏`,
    ...
    pricesError: `Narxlarni yuklashda xatolik.`,
    pressStart:  `/start bosing.`,

    pricesTitle: `💰 Xizmatlar narxi\n`,
    pricesCallout: `📲 Zakaz berish uchun yuqoridagi tugmani bosing`,
    unitSqm:     `m²`,
    unitPiece:   `dona`,
    unitMeter:   `metr`,
...
Хизматимиздан фойдаланганингиз учун раҳмат! 🙏`,
    ...
    noPrices:    `Нархлар ҳали киритилмаган.`,
    pricesError: `Нархларни юклашда хатолик.`,
    pressStart:  `/start босинг.`,

    pricesTitle: `💰 Хизматлар нархи\n`,
    pricesCallout: `📲 Заказ бериш учун юқоридаги тугмани босинг`,
    unitSqm:     `м²`,
    unitPiece:   `дона`,
    unitMeter:   `метр`,
